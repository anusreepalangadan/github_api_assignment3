...
import 'package:githubapiassignment/views/pages/repo_webView.dart';
class RepoTab extends StatelessWidget {
  List<RepoModel> repos;

  RepoTab({Key? key,required this.repos}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Repositories",style: TextStyle(color:  ColorRes.primaryColor),),
      ),
