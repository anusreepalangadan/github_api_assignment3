...
class ProfileTab extends StatelessWidget {
  UserModel userModel;
   ProfileTab({Key? key,required this.userModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Profile",style: TextStyle(color:  ColorRes.primaryColor),),
      ),
      body: SafeArea(
        child: Column(
          children: [
            ...
            Card(
                ...
                child: Padding(
                    ...
                    child: Text("Id:${userModel.id}",style: TextStyle(
                        letterSpacing: 2.0,
                        fontWeight: FontWeight.w300
                    ),))
            ),
                    ...
                    Expanded(
                      child: Column(
                        children: [
                          ...
                          Text(userModel.publicRepos!.toString(),
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 19.0,
                                fontWeight: FontWeight.w300
